...
1. `.docs/Project.md` or `Project.md`
2. `.docs/SCOPE.md` or `SCOPE.md`
3. Root `Plan.md`
4. Root `Tasks.md` (primary checklist)

Prefer Project/SCOPE over Task details on conflict; record conflicts.
